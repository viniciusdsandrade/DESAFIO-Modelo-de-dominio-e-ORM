...
-- Inserindo dados na tabela tb_participante
INSERT INTO tb_participante (email_participante, nome_participante)
...
-- Inserindo dados na tabela tb_atividade
INSERT INTO tb_atividade (descricao_atividade, nome_atividade, preco_atividade, categoria_id)
...
-- Inserindo dados na tabela tb_bloco
INSERT INTO tb_bloco (descricao_bloco, data_fim_bloco, data_inicio_bloco, atividade_id)
...
-- Inserindo dados na tabela tb_participante_atividade
